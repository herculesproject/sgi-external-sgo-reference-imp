...
/**
 * PaisPublicController
 */
@RestController
@RequestMapping(PaisPublicController.REQUEST_MAPPING)
@RequiredArgsConstructor
@Slf4j
public class PaisPublicController {

  public static final String PATH_DELIMITER = "/";
  public static final String PATH_PUBLIC = PATH_DELIMITER + "public";
  public static final String REQUEST_MAPPING = PATH_PUBLIC + PATH_DELIMITER + "paises";
