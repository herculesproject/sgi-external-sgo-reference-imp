...
/**
 * ProvinciaPublicController
 */
@RestController
@RequestMapping(ProvinciaPublicController.REQUEST_MAPPING)
@RequiredArgsConstructor
@Slf4j
public class ProvinciaPublicController {

  public static final String PATH_DELIMITER = "/";
  public static final String PATH_PUBLIC = PATH_DELIMITER + "public";
  public static final String REQUEST_MAPPING = PATH_PUBLIC + PATH_DELIMITER + "provincias";
  ...
  /**
   * Devuelve el {@link Provincia} con el id indicado.
   * 
