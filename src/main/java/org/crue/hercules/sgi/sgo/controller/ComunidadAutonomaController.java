...
/**
 * ComunidadAutonomaController
 */
@RestController
@RequestMapping(ComunidadAutonomaController.REQUEST_MAPPING)
@RequiredArgsConstructor
@Slf4j
public class ComunidadAutonomaController {

  public static final String PATH_DELIMITER = "/";
  public static final String REQUEST_MAPPING = PATH_DELIMITER + "comunidades-autonomas";
  ...
  /**
   * Devuelve la {@link ComunidadAutonoma} con el id indicado.
   * 
