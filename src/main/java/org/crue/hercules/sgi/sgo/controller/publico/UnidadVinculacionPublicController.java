...
/**
 * UnidadVinculacionPublicController
 */
@RestController
@RequestMapping(UnidadVinculacionPublicController.REQUEST_MAPPING)
@RequiredArgsConstructor
@Slf4j
public class UnidadVinculacionPublicController {

  public static final String PATH_DELIMITER = "/";
  public static final String PATH_PUBLIC = PATH_DELIMITER + "public";
  public static final String REQUEST_MAPPING = PATH_PUBLIC + PATH_DELIMITER + "unidades-vinculacion";
